...
namespace CalculoParaAcoesMVC.Controllers
{
    ...
    public class ZscoresController : Controller
    {
        ...
        public ZscoresController(CalculosDbContext context)
        {
            _context = context;
        }
        ...
        {
            return View(await _context.Zscore.ToListAsync());
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,DataCriado,NomeDaAcao,Variacao5Anos,Dias,DiasUteis,PrecoAberturaMes,Ewma,PrecoAtual,ValorZscore,AcimaValorAtual,AbaixoValorAtual")] Zscore zscore)
        {
            if (id != zscore.Id)
            {
                return NotFound();
